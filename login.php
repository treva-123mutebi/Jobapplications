...
$query=mysqli_query($con,"select * from user natural join branch where username='$user' and password='$pass' and branch_id='1' and status='active'")or die(mysqli_error($con));
