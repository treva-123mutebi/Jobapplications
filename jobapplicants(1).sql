...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2020 at 11:53 PM
...
INSERT INTO `applicants` (`ID`, `name`, `email`, `phonenumber`, `gender`, `dateofbirth`, `coverletter`, `cat_id`, `branch_id`, `yearsofexperience`, `notes`, `skills`, `cv`, `size`, `downloads`) VALUES
(8, 'Namere Foods', 'foods@namere.com', '0775220222', 'male', '1993-04-01', 'I hold working experience of over 3 years with wealth of skills in server-side programming with PHP and Python, Database Management with MySQL and Mongo DB, Creation and consumption of REST and SOAP services, working with Laravel Framework and Django Framework, writing quality unit tests, creating and debugging algorithms and data structures, creating and usage of firewalls for website security, frontend programming with HTML, bootstrap, CSS, alongside Express.js and Node.js. I’m currently pursuing Bachelor’s degree in Software Engineering at ISBAT University, Advanced Diploma in Software Engineering at Aptech Computer Education. I hold a certificate in Information Technology management from Seeta High School Computer Club and Certificate in Web Development from Web-Info Net – Ham Towers. With this background, I strongly believe in myself as a very suitable person to create, support, coordinate Web Development and Design efficiently and effectively, aligned to support attainment of project goals and client expectations.', 13, 1, '5-10', 'I cook good Food', 'HTML,CSS,JS', 'cvs/Mutebi David CV.docx', 0, 0),
(9, 'Jennifer Aletu', 'aletujenny@yahoo.com', '0758132682', 'female', '1999-09-05', 'RE: APPLICATION FOR POST OF FULL STACK WEB DEVELOPER.\r\n\r\nI hereby apply for an opportunity to offer services as Full Stack Web Developer. I have faithfully executed similar tasks listed on this post in the past 3 years, initially designing my personal website about my Christian Faith and daily motivation, The Daily Trevor which can be found through the following link https://dailytrevor.netlify.app .  in 2017 and participating in the setting up of online business directory between 2018 and 2019 to enable various businesses advertise their services on the internet under my internship program at Lwega Tech. I’m currently involved in setting up an online booking site for JR Blush and Glow a makeup and saloon startup company which played key role in gathering and organizing bookings from their clients, the site can be found at https://jrblushandglow.netlify.app . During the COVID-19 worldwide pandemic I set up an awareness site to address what the covid-19 virus is, how the covid-19 virus spreads and how we can protect ourselves from the covid-19 virus alongside a self-test quiz and user-survey in the site, the site can be found through the following link https://sandtc19.netlify.app .  I have led an exemplary lifestyle being a team leader, committed, trustworthy, self-motivated, and hardworking and result oriented person with high moral integrity and ability to work in multi-cultural and multi-disciplinary teams in different circumstances. My ambition has always been to work in target oriented an environment where I impact lives positively and add value in various aspects.\r\n', 13, 1, '10+', 'I love GitHub', 'JS,React-Native,Laravel,Django', 'cvs/Mutebi Trevor Web Developer Cover Letter.docx', 0, 0);
