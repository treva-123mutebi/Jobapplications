...
<?php
        ...
        $query=mysqli_query($con,"select * from applicants natural join category where branch_id='1' order by cat_name")or die(mysqli_error());
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
					...
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['ID'];?>" required>  
                    <input type="text" class="form-control" id="name" name="skills" value="<?php echo $row['skills'];?>" readonly>  
					</div>
        </div>
        <br/><br/><br/>
        <div class="form-group">
					...
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['ID'];?>" required>  
                    <input type="text" class="form-control" id="name" name="yearsofexperience" value="<?php echo $row['yearsofexperience'];?>" readonly>  
					</div>
        </div>
        <br/><br/>
        <div class="form-group">
